...
% 注：以上是自己写的；以下是根据matlab的库修改的。由于matlab库内rgb2ycbcr出来范围16-255，需求是0-255；但是matlab这个写法运算速度非常快，所以搬过来修改转换矩阵，让输出和上面自己写的结果相

function ycbcr = jpeg_rgb2ycocg(varargin)
    ...
    %             ];
    % origT = 255 * [0.299, 0.587, 0.114;
    %             0.5959, -0.2746, -0.6213;
    %             0.2115, -0.5227, 0.3112
    %             ];
    origT = 255 * [0.25, 0.5, 0.25;
                0.5, 0, -0.5;
                -0.25, 0.5, -0.25
                ];
